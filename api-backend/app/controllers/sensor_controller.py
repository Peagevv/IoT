...
from flask import jsonify, request, make_response
from app.models.sensor_model import SensorModel
# Ya no se importa websocket - ws_server.py maneja las notificaciones
...
class SensorController:
    ...
    def create_manual_obstacle():
        try:
            ...
            # ✅ Ya NO notificamos aquí - ws_server.py lo hace automáticamente
            # cuando recibe la petición HTTP POST
